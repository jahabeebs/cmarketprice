<template>
  <div class="flex container flex-col">
    <div class="title font-bold text-center md:text-2xl sm:text-xs" v-if="loaded">Sugar (world), International Sugar Agreement (ISA)
      daily price, raw | FOB Greater Caribbean ports
    </div>
