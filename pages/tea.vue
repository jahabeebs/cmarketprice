<template>
  <div class="flex container flex-col">
    <div class="title font-bold text-center md:text-2xl sm:text-xs" v-if="loaded">Tea, average three auctions, arithmetic
      average of quotations at Kolkata, Colombo and Mombasa/Nairobi. | World
    </div>
